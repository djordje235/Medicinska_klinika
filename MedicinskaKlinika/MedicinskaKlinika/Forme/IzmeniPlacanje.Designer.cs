namespace MedicinskaKlinika.Forme
{
    partial class IzmeniPlacanje
    {
        ...
        private void InitializeComponent()
        {
            ...
            IdPlacanja = new ColumnHeader();
            ProcenatPacijenta = new ColumnHeader();
            Racun = new ColumnHeader();
            NacinPlacanja = new ColumnHeader();
            PlatioPacijent = new ColumnHeader();
            ...
            button3.Location = new Point(713, 435);
            ...
            button2.Location = new Point(365, 435);
            ...
            button1.Location = new Point(25, 435);
            ...
            // listView1
            // 
            listView1.Columns.AddRange(new ColumnHeader[] { IdPlacanja, ProcenatPacijenta, Racun, NacinPlacanja, PlatioPacijent, Osiguranje, BrPolise, OsiguravajucaKuca });
            ...
            // IdPlacanja
            // 
            IdPlacanja.Text = "IdPlacanja";
            IdPlacanja.Width = 100;
            // 
            // ProcenatPacijenta
            // 
            ProcenatPacijenta.Text = "ProcenatPacijenta";
            ProcenatPacijenta.Width = 100;
            // 
            // Racun
            // 
            Racun.Text = "Racun";
            ...
            NacinPlacanja.Width = 100;
            // 
            // PlatioPacijent
            // 
            PlatioPacijent.Text = "PlatioPacijent";
            PlatioPacijent.Width = 100;
            // 
            // Osiguranje
            // 
        ...
        private ColumnHeader IdPlacanja;
        private ColumnHeader ProcenatPacijenta;
        private ColumnHeader Racun;
        private ColumnHeader NacinPlacanja;
        private ColumnHeader PlatioPacijent;
