...
namespace Medicinska_klinika_3._0.FormeIzmeni
{
    public partial class IzmeniLekara : Form
    {
        ...
        {
            DodajLekaraForma forma = new DodajLekaraForma(false,null);
            forma.ShowDialog();
            IzmeniLekara_Load(sender,e);
        }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            DodajLekaraForma forma = new DodajLekaraForma(true,admin);
            forma.ShowDialog();
            IzmeniLekara_Load(sender, e);
        }
        ...
        private void IzmeniLekara_Load(object sender, EventArgs e)
        {
            ...
            listView1.Columns.Add("Specijalizacija");
            listView1.Columns.Add("BrojLicence");

            listView1.Items.Clear();

            List<LekarBasic> admini = DTOManager.prikazLekara();
            ...
            foreach (var a in admini)
            {
                ...
                item.SubItems.Add(a.Specijalizacija);
                item.SubItems.Add(a.BrLicence.ToString());
